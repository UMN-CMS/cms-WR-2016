...
void Plotter(TString region){
	...
	if(region == "signalAMC"){
		...
		chain_DY->Add(inputDir+"selected_tree_data_lowdileptonsidebandEE.root");
		chain_DY2->Add(inputDir+"selected_tree_data_lowdileptonsidebandMuMu.root");		
	}
  ...
  TString ytitles[] = {"dN/dp_{T} (GeV^{-1})","dN/dp_{T} (GeV^{-1})","dN/dp_{T} (GeV^{-1})","dN/dp_{T} (GeV^{-1})","dN/d#eta","dN/d#eta","dN/d#eta","dN/d#eta","dN/d#phi","dN/d#phi","dN/d#phi","dN/d#phi","dN/dMlljj (GeV^{-1})","dN/dMlljj (GeV^{-1})","dN/dmass (GeV^{-1})","dN/dnPV","dN/dHT","dN/dp_{T} (GeV^{-1})","dN/dMl_{1}jj (GeV^{-1})","dM/dMl_{2}jj (GeV^{-1})", "dN/dNJets", "dN/dS_{T}","dN/d#Delta#phi"};
	...
	for(unsigned int i = 0; i < nPlots; i++){
		...
		drawPlots(hs_DY[i],hs_DY2[i],hs_ttbar[i],hs_ttbar2[i],hs_others[i],hs_others2[i],hs_data[i],hs_data2[i],xtitles[i],ytitles[i],fnames[i], region);
	}
