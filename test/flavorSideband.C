...
void flavorSideband(){
  ...
  TString stdTitle = "CMS Preliminary            35.87 fb^{-1} (13 TeV)";
  ...
  leg_EE->Draw();
  mycanvas_EE->Print(("plots/flavor_EE_variablebinwidth.pdf"));
  mycanvas_EE->Print(("plots/flavor_EE_variablebinwidth.png"));
  ...
  leg_MuMu->Draw();
  mycanvas_MuMu->Print(("plots/flavor_MuMu_variablebinwidth.pdf"));
  mycanvas_MuMu->Print(("plots/flavor_MuMu_variablebinwidth.png"));
  ...
  f_EE->Draw("same");
  mycanvas_ratio_EE->Print(("plots/flavor_ratio_EE_variablebinwidth.pdf"));
  mycanvas_ratio_EE->Print(("plots/flavor_ratio_EE_variablebinwidth.png"));
  ...
  mycanvas_ratio_EE->Print(("plots/flavor_ratio_EE_variablebinwidth_logx.pdf"));
  mycanvas_ratio_EE->Print(("plots/flavor_ratio_EE_variablebinwidth_logx.png"));
  ...
  legMuMuEMu->Draw();
  canvMuMuEMu->SaveAs("plots/emujj_and_mumujj_signal_region_variablebinwidth.pdf","recreate");
  canvMuMuEMu->SaveAs("plots/emujj_and_mumujj_signal_region_variablebinwidth.png","recreate");
  ...
  legMuMuEMuData->Draw();
  canvMuMuEMuData->SaveAs("plots/rescaled_emujj_data_and_mumujj_MC_signal_region_variablebinwidth.pdf","recreate");
  canvMuMuEMuData->SaveAs("plots/rescaled_emujj_data_and_mumujj_MC_signal_region_variablebinwidth.png","recreate");
  ...
  legEEEMu->Draw();
  canvEEEMu->SaveAs("plots/emujj_and_eejj_signal_region_variablebinwidth.pdf","recreate");
  canvEEEMu->SaveAs("plots/emujj_and_eejj_signal_region_variablebinwidth.png","recreate");
  ...
  h_WR_mass_EMuData->Draw("Psame");
  legEEEMuData->Draw();
  canvEEEMuData->SaveAs("plots/rescaled_emujj_data_and_eejj_MC_signal_region_variablebinwidth.pdf","recreate");
  canvEEEMuData->SaveAs("plots/rescaled_emujj_data_and_eejj_MC_signal_region_variablebinwidth.png","recreate");
  ...
  canvEMuDataTwoRescaledMCs->SaveAs("plots/emujj_data_and_MC_and_rescaled_eejj_and_mumujj_MC_signal_region_variablebinwidth.pdf","recreate");
  canvEMuDataTwoRescaledMCs->SaveAs("plots/emujj_data_and_MC_and_rescaled_eejj_and_mumujj_MC_signal_region_variablebinwidth.png","recreate");

  p1->SetLogy();
  canvEMuDataTwoRescaledMCs->SaveAs("plots/emujj_data_and_MC_and_rescaled_eejj_and_mumujj_MC_signal_region_log_variablebinwidth.pdf","recreate");
  canvEMuDataTwoRescaledMCs->SaveAs("plots/emujj_data_and_MC_and_rescaled_eejj_and_mumujj_MC_signal_region_log_variablebinwidth.png","recreate");
