...
class Selector
{
 public:
  ...
  Float_t lead_lepton_HoverEM;
  Float_t lead_lepton_dxy;
  Float_t lead_lepton_dB;
  Float_t lead_lepton_dxyError;
  Float_t lead_lepton_pfIso;
  Float_t lead_lepton_GsfEleEmHadD1IsoRhoCut;
  Float_t lead_lepton_GsftrkIso;
  Float_t lead_lepton_trkIso;
  Int_t lead_lepton_satCrystal;
  Int_t lead_lepton_heepBitmap;
  Float_t sublead_lepton_HoverEM;
  Float_t sublead_lepton_dxy;
  Float_t sublead_lepton_dB;
  Float_t sublead_lepton_dxyError;
  Float_t sublead_lepton_pfIso;
  Float_t sublead_lepton_GsfEleEmHadD1IsoRhoCut;
  Float_t sublead_lepton_GsftrkIso;
  Float_t sublead_lepton_trkIso;
  Int_t sublead_lepton_satCrystal;
  Int_t sublead_lepton_heepBitmap;
  ...
  bool isPassingQCD(tag_t tag, bool makeHists = false);
