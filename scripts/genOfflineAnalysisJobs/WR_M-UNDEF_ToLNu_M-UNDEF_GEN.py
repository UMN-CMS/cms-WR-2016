...
# with command line options: WprimeToENu_M-2000_TuneCUETP8M1_13TeV-pythia8_cff --conditions auto:run2_mc -n 5 --eventcontent FEVTDEBUG -s GEN,SIM --datatier GEN-SIM --mc --beamspot Realistic25ns13TeV2016Collision --fileout file:WR-2400_ToLNu-1200_ToEEJJ_NEW-GEN-SIM.root --no_exec
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(EVTCT)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('WprimeToENu_M-2000_TuneCUETP8M1_13TeV-pythia8_cff nevts:1000'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    PythiaParameters = cms.PSet(
        parameterSets = cms.vstring('pythia8CommonSettings', 
            ...
            'processParameters'),
        processParameters = cms.vstring('LeftRightSymmmetry:ffbar2WR = on', 
            '9900024:m0 = MMAASS',
            '9900012:m0 = MASSNU',
            '9900014:m0 = MASSNU',
            '9900016:m0 = MASSNU',
            '9900024:onMode = off',
            '9900024:onIfAny = 11,9900012' #for the double electron final state
            # '9900024:onIfAny = 13 9900014' #for the double muon final state
            ),
