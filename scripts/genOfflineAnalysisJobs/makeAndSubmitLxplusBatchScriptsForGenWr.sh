...
#run this script from the scripts/genOfflineAnalysisJobs/. directory
...
jobStartingDir="$PWD/../.."
gridProxyPath="/afs/cern.ch/user/g/gnegro/x509up_u39115"
# leptonChannel="MuMu"  #change MuMu to EE to switch lepton channels
leptonChannel="EE"
outputFileDir="/afs/cern.ch/work/g/gnegro/public/WR16-Moriond17/privateWRGen/analyzedGen"	#do not add a fwd slash at the end of this string
